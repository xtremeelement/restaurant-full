                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="/admin/food-categories/1/delete" onclick="if (! confirm('Are you sure you want to delete this category?')) { return false;}"><i class="fas fa-trash-alt"></i></i></a></td>
                                            </tr>                                           
                                        </tbody>
                                    </table>
                                </div>
